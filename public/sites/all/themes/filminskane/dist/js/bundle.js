...
var frontSlide = {
  init: function init() {
    (0, _jquery2.default)('.view-display-id-f_slide').owlCarousel({
      navigation: true,
      slideSpeed: 300,
      paginationSpeed: 400,
      singleItem: true
...
var prePageNavToggle = {
  init: function init() {
    ...
    (0, _jquery2.default)('.block-boxes-external-links-toggle').delegate('.other-sites-toggler', 'click', function () {
      (0, _jquery2.default)('.other-sites-toggler a span').toggleClass('up down');
      (0, _jquery2.default)('.block-boxes-external-links-menu').slideToggle('slow');
    });
  }
};
...
var _prePageMenu = require('./lib/pre-page-menu');

var _prePageMenu2 = _interopRequireDefault(_prePageMenu);

var _frontSlide = require('./lib/front-slide');
